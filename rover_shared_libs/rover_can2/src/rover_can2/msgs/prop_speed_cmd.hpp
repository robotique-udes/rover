#ifndef ROVER_CAN2_MSGS_PROP_SPEED_CMD_HPP
#define ROVER_CAN2_MSGS_PROP_SPEED_CMD_HPP
...
{
    class PropSpeedCmd : public Msg<PropSpeedCmd>
    {
      public:
      ...
      public:
        PropSpeedCmd():
            Msg(Constant::eMsgId::PROP_SPEED_CMD)
        {
            _data.target_speed = static_cast<decltype(_data.target_speed)>(0);
        }
...
#endif  // ROVER_CAN2_MSGS_PROP_SPEED_CMD_HPP
