#ifndef ROVER_CAN2_MSGS_FIX_HEADING_HPP
#define ROVER_CAN2_MSGS_FIX_HEADING_HPP

#include "rover_can2/msgs/msg.hpp"
#include "rover_can2/helpers.hpp"

DEFINE_LOG_NODE(FixHeading_msg, Logger::eNodeState::OFF)

namespace RoverCan2::Msgs
{
    class FixHeading : public Msg<FixHeading>
    {
      public:
      ...
      private:
        ...
        static constexpr CompileTimeArray<eMsgContentID, TO_UNDERLYING(eMsgContentID::eLAST)> VALID_MSG_IDS
            = {eMsgContentID::HEADING_DEG};

      public:
        FixHeading():
            Msg(Constant::eMsgId::FIX_HEADING)
        {
            _data.headingDeg = static_cast<decltype(_data.headingDeg)>(0);
        }
        ...
        eLoadMsgCode _loadMsg(const CanMsg& msg_)
        {
            ...
            {
                LOG_DEBUG(Logger::Nodes::FixHeading_msg,
            ...
            switch (msgContentId)
            {
                case eMsgContentID::HEADING_DEG:
                    success = Helpers::CAN_MSG_TO_ROVER_MSG_CONTENT(msg_, _data.headingDeg);
                    LOG_DEBUG(Logger::Nodes::FixHeading_msg,
                              "switch (msgContentId) case eMsgContentID::HEADING_DEG: %s",
        ...
        std::optional<CanMsg> _getCanMsg(const uint8_t msgContentId_) const
        {
            ...
            {
                case eMsgContentID::HEADING_DEG:
                    Helpers::ROVER_MSG_CONTENT_TO_CAN_MSG(this->getMsgId(), msgContentId_, _data.headingDeg, msg_);
                    break;
...
#endif  // ROVER_CAN2_MSGS_FIX_HEADING_HPP
