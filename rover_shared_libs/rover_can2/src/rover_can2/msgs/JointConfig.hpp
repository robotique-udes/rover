#ifndef JOINTCONFIG_HPP
#define JOINTCONFIG_HPP

#include "rover_can2/msgs/msg.hpp"
#include "rover_can2/helpers.hpp"

DEFINE_LOG_NODE(Jointconfig_msg, Logger::eNodeState::OFF)

namespace RoverCan2::Msgs
{
    class Jointconfig : public Msg<Jointconfig>
    {
      public:
      ...
      private:
        ...
        static constexpr CompileTimeArray<eMsgContentID, TO_UNDERLYING(eMsgContentID::eLAST)> VALID_MSG_IDS
            = {eMsgContentID::UPPER_LIMIT, eMsgContentID::LOWER_LIMIT, eMsgContentID::MAX_SPEED, eMsgContentID::KP_SPEED, eMsgContentID::KD_SPEED, eMsgContentID::KI_SPEED};

      public:
        Jointconfig():
            Msg(Constant::eMsgId::JOINTCONFIG)
        {
        ...
        eLoadMsgCode _loadMsg(const CanMsg& msg_)
        {
            ...
            {
                LOG_DEBUG(Logger::Nodes::Jointconfig_msg,
