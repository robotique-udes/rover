#ifndef ARM_JOINT_INFO_HPP
#define ARM_JOINT_INFO_HPP

#include "rover_can2/msgs/msg.hpp"
#include "rover_can2/helpers.hpp"

DEFINE_LOG_NODE(ArmJointInfo_msg, Logger::eNodeState::OFF)

namespace RoverCan2::Msgs
{

    class ArmJointInfo : public Msg<ArmJointInfo>
    {
      public:
      ...
      private:
        ...
        static constexpr CompileTimeArray<eMsgContentID, TO_UNDERLYING(eMsgContentID::eLAST)> VALID_MSG_IDS
            = {eMsgContentID::JOINT_LIMIT_REACHED};
