...
DEFINE_LOG_NODE(DdbStatus_msg, Logger::eNodeState::OFF)

namespace RoverCan2::Msgs
{
    class DdbStatus : public Msg<DdbStatus>
    {
      public:
    ...
    DdbStatus::DdbStatus():
        Msg(Constant::eMsgId::DDB_STATUS)
    {
    ...
    eLoadMsgCode DdbStatus::_loadMsg(const CanMsg& msg_)
    {
        ...
        {
            LOG_DEBUG(Logger::Nodes::DdbStatus_msg,
    ...
    std::optional<CanMsg> DdbStatus::_getCanMsg(const uint8_t msgContentId_) const
    {
    ...
    uint8_t DdbStatus::_getMsgContentCount(void) const
    {
        return TO_UNDERLYING(eMsgContentID::eLAST);
    }

    DdbStatus::sMsgData& DdbStatus::data(void)
    {
        return _data;
    }
    
    const DdbStatus::sMsgData& DdbStatus::getData(void) const
    {
        return static_cast<const DdbStatus::sMsgData&>(_data);
    }
}  // namespace RoverCan2::Msgs
