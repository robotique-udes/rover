...
namespace RoverCan2::Constant
{
    ...
    constexpr CompileTimeArray<eMsgId, 22UL> SUPPORTED_MSGS = {
        eMsgId::TEST_MSG,       eMsgId::TEST_MSG_2,        eMsgId::ERROR_STATE,
        eMsgId::HEARTBEAT,      eMsgId::POWER_CMD,         eMsgId::POWER_STATUS,
        eMsgId::PWM_CMD,        eMsgId::PWM_STATUS,        eMsgId::PWM_INFO,
        eMsgId::PROP_SPEED_CMD, eMsgId::PROP_SPEED_STATUS, eMsgId::DDB_CMD,
        eMsgId::DDB_STATUS,     eMsgId::FIX_POSITION,      eMsgId::FIX_HEADING,
        eMsgId::FIX_INFO,       eMsgId::PTZ_CMD,           eMsgId::PTZ_STATUS,
        eMsgId::PTZ_CONFIG,     eMsgId::ARM_JOINT_CONFIG,  eMsgId::ARM_POSITION_STATUS,
        eMsgId::ARM_SPEED_CMD,
    };
