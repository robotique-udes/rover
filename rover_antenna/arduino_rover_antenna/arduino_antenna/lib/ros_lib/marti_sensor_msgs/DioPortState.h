#ifndef _ROS_marti_sensor_msgs_DioPortState_h
#define _ROS_marti_sensor_msgs_DioPortState_h
...
namespace marti_sensor_msgs
{
  ...
  class DioPortState : public ros::Msg
  {
    public:
    ...
    virtual const char * getType() override { return "marti_sensor_msgs/DioPortState"; };
