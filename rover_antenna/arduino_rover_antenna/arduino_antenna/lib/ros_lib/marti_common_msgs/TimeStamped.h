#ifndef _ROS_marti_common_msgs_TimeStamped_h
#define _ROS_marti_common_msgs_TimeStamped_h
...
namespace marti_common_msgs
{
  ...
  class TimeStamped : public ros::Msg
  {
    ...
    virtual const char * getType() override { return "marti_common_msgs/TimeStamped"; };
    virtual const char * getMD5() override { return "11824e1dcaada3bc61a736ee15c7f0c8"; };
