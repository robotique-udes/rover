...
static const char QUERYALARMS[] = "robotnik_msgs/QueryAlarms";
  ...
  class QueryAlarmsRequest : public ros::Msg
  {
    ...
    virtual const char * getType() override { return QUERYALARMS; };
    virtual const char * getMD5() override { return "f1be883ec4718e1184241817a2fe2b57"; };
  ...
  class QueryAlarmsResponse : public ros::Msg
  {
    ...
    virtual const char * getType() override { return QUERYALARMS; };
    virtual const char * getMD5() override { return "6d2c5e83064a46d4d198ba7049acbc1c"; };
