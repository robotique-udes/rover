...
namespace robotnik_msgs
{
  ...
  class named_inputs_outputs : public ros::Msg
  {
    ...
    virtual const char * getType() override { return "robotnik_msgs/named_inputs_outputs"; };
    virtual const char * getMD5() override { return "e3301c19a16019595490fc28259868bd"; };
