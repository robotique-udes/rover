...
namespace robotnik_msgs
{
  ...
  class inputs_outputs : public ros::Msg
  {
    ...
    inputs_outputs():
      digital_inputs_length(0), st_digital_inputs(), digital_inputs(nullptr),
      digital_outputs_length(0), st_digital_outputs(), digital_outputs(nullptr),
      analog_inputs_length(0), st_analog_inputs(), analog_inputs(nullptr),
      analog_outputs_length(0), st_analog_outputs(), analog_outputs(nullptr)
    {
    }
    ...
    virtual const char * getType() override { return "robotnik_msgs/inputs_outputs"; };
    virtual const char * getMD5() override { return "219be75bd56b8ebdca0dfa526c3803be"; };
