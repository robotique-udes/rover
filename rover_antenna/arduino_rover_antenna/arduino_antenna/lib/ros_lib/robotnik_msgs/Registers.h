...
namespace robotnik_msgs
{
  ...
  class Registers : public ros::Msg
  {
    ...
    Registers():
      registers_length(0), st_registers(), registers(nullptr)
    {
    }
    ...
    virtual const char * getType() override { return "robotnik_msgs/Registers"; };
    virtual const char * getMD5() override { return "12d8645a7a01078095f8477105240cef"; };
