...
namespace robotnik_msgs
{
  ...
  class encoders : public ros::Msg
  {
    ...
    encoders():
      ...
      counts_length(0), st_counts(), counts(nullptr),
    ...
    virtual const char * getType() override { return "robotnik_msgs/encoders"; };
    virtual const char * getMD5() override { return "b5def35e667417de284b17ffe2083938"; };
