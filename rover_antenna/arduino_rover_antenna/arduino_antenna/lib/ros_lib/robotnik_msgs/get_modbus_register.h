...
static const char GET_MODBUS_REGISTER[] = "robotnik_msgs/get_modbus_register";
  ...
  class get_modbus_registerRequest : public ros::Msg
  {
    ...
    virtual const char * getType() override { return GET_MODBUS_REGISTER; };
    virtual const char * getMD5() override { return "dff3ccdc45e0333e4e8a2e8d7bdf4f6a"; };
  ...
  class get_modbus_registerResponse : public ros::Msg
  {
    ...
    virtual const char * getType() override { return GET_MODBUS_REGISTER; };
    virtual const char * getMD5() override { return "538660b29f52203f8c773272f9bff3df"; };
