...
namespace robotnik_msgs
{
  ...
  class BatteryDockingStatus : public ros::Msg
  {
    ...
    virtual const char * getType() override { return "robotnik_msgs/BatteryDockingStatus"; };
    virtual const char * getMD5() override { return "d7c3a4e25e4a4a665c4a1dd0862edfc2"; };
