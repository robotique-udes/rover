#ifndef _ROS_differential_drive_VelocityTargets_h
#define _ROS_differential_drive_VelocityTargets_h
...
namespace differential_drive
{
  ...
  class VelocityTargets : public ros::Msg
  {
    public:
    ...
    virtual const char * getType() override { return "differential_drive/VelocityTargets"; };
