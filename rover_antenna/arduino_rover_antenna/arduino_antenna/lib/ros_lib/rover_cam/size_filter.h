#ifndef _ROS_SERVICE_size_filter_h
#define _ROS_SERVICE_size_filter_h
#include <stdint.h>
#include <string.h>
#include <stdlib.h>
#include "ros/msg.h"
...
static const char SIZE_FILTER[] = "rover_cam/size_filter";

  class size_filterRequest : public ros::Msg
  {
    public:
    ...
    virtual const char * getType() override { return SIZE_FILTER; };
    virtual const char * getMD5() override { return "b9d91fa4bb72869edb94b0a757508ee0"; };

  };

  class size_filterResponse : public ros::Msg
  {
    public:
  ...
  class size_filter {
    public:
    typedef size_filterRequest Request;
    typedef size_filterResponse Response;
  };
