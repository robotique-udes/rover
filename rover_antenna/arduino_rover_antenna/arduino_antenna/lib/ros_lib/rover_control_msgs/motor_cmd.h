#ifndef _ROS_rover_control_msgs_motor_cmd_h
#define _ROS_rover_control_msgs_motor_cmd_h
...
namespace rover_control_msgs
{
  ...
  class motor_cmd : public ros::Msg
  {
    ...
    virtual const char * getType() override { return "rover_control_msgs/motor_cmd"; };
    virtual const char * getMD5() override { return "704d6e45a144b051d9261eee9f265122"; };
