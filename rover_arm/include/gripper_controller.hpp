...
//         if (_joyController.isPressed(inputArray_[TO_UNDERLYING(KEYBINDINGS::EMILE::GRIPPER::ROT_FWD)]))
//         {
...
//         }
//         else if (_joyController.isPressed(inputArray_[TO_UNDERLYING(KEYBINDINGS::EMILE::GRIPPER::ROT_REV)]))
//         {
//             _currentControlledJoint = ARM_CONFIGURATION::GRIPPER_ROT::ID;
//             jointCommands[TO_UNDERLYING(_currentControlledJoint)] = -1.0F * getMaxVelocity(ARM_CONFIGURATION::GRIPPER_ROT::ID);
//         }

//         if (_joyController.isPressed(inputArray_[TO_UNDERLYING(KEYBINDINGS::EMILE::GRIPPER::TILT_FWD)]))
//         {
