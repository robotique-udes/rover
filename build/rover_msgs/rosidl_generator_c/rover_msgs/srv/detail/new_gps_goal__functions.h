...
#ifndef ROVER_MSGS__SRV__DETAIL__NEW_GPS_GOAL__FUNCTIONS_H_
#define ROVER_MSGS__SRV__DETAIL__NEW_GPS_GOAL__FUNCTIONS_H_
...
/// Initialize srv/NewGpsGoal message.
/**
...
/// Finalize srv/NewGpsGoal message.
/**
...
/// Create srv/NewGpsGoal message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * rover_msgs__srv__NewGpsGoal_Request__init().
...
/// Destroy srv/NewGpsGoal message.
/**
 * It calls
 * rover_msgs__srv__NewGpsGoal_Request__fini()
...
/// Check for srv/NewGpsGoal message equality.
/**
...
/// Initialize array of srv/NewGpsGoal messages.
/**
...
/// Finalize array of srv/NewGpsGoal messages.
/**
 * It calls
 * rover_msgs__srv__NewGpsGoal_Request__fini()
...
/// Create array of srv/NewGpsGoal messages.
/**
 * It allocates the memory for the array and calls
 * rover_msgs__srv__NewGpsGoal_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/NewGpsGoal messages.
/**
 * It calls
 * rover_msgs__srv__NewGpsGoal_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/NewGpsGoal message array equality.
/**
...
/// Copy an array of srv/NewGpsGoal messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * rover_msgs__srv__NewGpsGoal_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_rover_msgs
...
/**
 * It calls
 * rover_msgs__srv__NewGpsGoal_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_rover_msgs
...
/**
 * It allocates the memory for the array and calls
 * rover_msgs__srv__NewGpsGoal_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_rover_msgs
...
/**
 * It calls
 * rover_msgs__srv__NewGpsGoal_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // ROVER_MSGS__SRV__DETAIL__NEW_GPS_GOAL__FUNCTIONS_H_
