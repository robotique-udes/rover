...
#include "rover_msgs/msg/detail/joy__rosidl_typesupport_fastrtps_c.h"
...
using _Joy__ros_msg_type = rover_msgs__msg__Joy;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  {
    size_t size = 20;
    auto array_ptr = ros_message->joy_data;
...
size_t get_serialized_size_rover_msgs__msg__Joy(
  const void * untyped_ros_message,
...
static uint32_t _Joy__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_rover_msgs__msg__Joy(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_rover_msgs
size_t max_serialized_size_rover_msgs__msg__Joy(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = rover_msgs__msg__Joy;
    is_plain =
      (
...
static size_t _Joy__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_rover_msgs__msg__Joy(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rover_msgs, msg, Joy)() {
