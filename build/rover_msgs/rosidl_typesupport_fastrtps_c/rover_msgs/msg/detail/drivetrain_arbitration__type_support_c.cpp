...
#include "rover_msgs/msg/detail/drivetrain_arbitration__rosidl_typesupport_fastrtps_c.h"
...
using _DrivetrainArbitration__ros_msg_type = rover_msgs__msg__DrivetrainArbitration;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _DrivetrainArbitration__ros_msg_type * ros_message = static_cast<const _DrivetrainArbitration__ros_msg_type *>(untyped_ros_message);
  ...
  void * untyped_ros_message)
{
  ...
  _DrivetrainArbitration__ros_msg_type * ros_message = static_cast<_DrivetrainArbitration__ros_msg_type *>(untyped_ros_message);
  // Field name: arbitration
  {
    cdr >> ros_message->arbitration;
  }
...
static uint32_t _DrivetrainArbitration__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_rover_msgs__msg__DrivetrainArbitration(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = rover_msgs__msg__DrivetrainArbitration;
    is_plain =
      (
...
static size_t _DrivetrainArbitration__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_rover_msgs__msg__DrivetrainArbitration(
...
static message_type_support_callbacks_t __callbacks_DrivetrainArbitration = {
  "rover_msgs::msg",
...
static rosidl_message_type_support_t _DrivetrainArbitration__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_DrivetrainArbitration,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rover_msgs, msg, DrivetrainArbitration)() {
  return &_DrivetrainArbitration__type_support;
}
