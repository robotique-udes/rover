...
#include "rover_msgs/msg/detail/camera_control__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const rover_msgs::msg::CameraControl & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  rover_msgs::msg::CameraControl & ros_message)
{
  // Member: enable
  {
    cdr >> ros_message.enable;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = rover_msgs::msg::CameraControl;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const rover_msgs::msg::CameraControl *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<rover_msgs::msg::CameraControl *>(
    untyped_ros_message);
...
{
  return &rover_msgs::msg::typesupport_fastrtps_cpp::_CameraControl__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rover_msgs, msg, CameraControl)() {
  return &rover_msgs::msg::typesupport_fastrtps_cpp::_CameraControl__handle;
}
