...
#include "rover_msgs/msg/detail/joy__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const rover_msgs::msg::Joy & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: joy_data
  {
    cdr << ros_message.joy_data;
  }
  return true;
}
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  rover_msgs::msg::Joy & ros_message)
{
  // Member: joy_data
  {
    cdr >> ros_message.joy_data;
  ...
  size_t current_alignment)
{
  ...
  // Member: joy_data
  {
    ...
    size_t item_size = sizeof(ros_message.joy_data[0]);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = rover_msgs::msg::Joy;
    is_plain =
      (
      offsetof(DataType, joy_data) +
      last_member_size
      ) == ret_val;
  }
...
{
  auto typed_message =
    static_cast<const rover_msgs::msg::Joy *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<rover_msgs::msg::Joy *>(
    untyped_ros_message);
...
{
  return &rover_msgs::msg::typesupport_fastrtps_cpp::_Joy__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rover_msgs, msg, Joy)() {
  return &rover_msgs::msg::typesupport_fastrtps_cpp::_Joy__handle;
}
