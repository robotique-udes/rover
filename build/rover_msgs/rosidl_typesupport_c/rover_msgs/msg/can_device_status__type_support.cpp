...
static const _CanDeviceStatus_type_support_symbol_names_t _CanDeviceStatus_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rover_msgs, msg, CanDeviceStatus)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rover_msgs, msg, CanDeviceStatus)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, rover_msgs, msg, CanDeviceStatus)() {
  return &::rover_msgs::msg::rosidl_typesupport_c::CanDeviceStatus_message_type_support_handle;
}
