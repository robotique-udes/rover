...
static const _ScreenshotControl_Request_type_support_symbol_names_t _ScreenshotControl_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rover_msgs, srv, ScreenshotControl_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rover_msgs, srv, ScreenshotControl_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, rover_msgs, srv, ScreenshotControl_Request)() {
  return &::rover_msgs::srv::rosidl_typesupport_c::ScreenshotControl_Request_message_type_support_handle;
}
...
static const _ScreenshotControl_Response_type_support_symbol_names_t _ScreenshotControl_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rover_msgs, srv, ScreenshotControl_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rover_msgs, srv, ScreenshotControl_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, rover_msgs, srv, ScreenshotControl_Response)() {
  return &::rover_msgs::srv::rosidl_typesupport_c::ScreenshotControl_Response_message_type_support_handle;
}
...
static const _ScreenshotControl_type_support_symbol_names_t _ScreenshotControl_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rover_msgs, srv, ScreenshotControl)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rover_msgs, srv, ScreenshotControl)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, rover_msgs, srv, ScreenshotControl)() {
  return &::rover_msgs::srv::rosidl_typesupport_c::ScreenshotControl_service_type_support_handle;
}
