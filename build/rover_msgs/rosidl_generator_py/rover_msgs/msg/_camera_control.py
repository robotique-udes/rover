...
class Metaclass_CameraControl(type):
    ...
    def __prepare__(cls, name, bases, **kwargs):
        ...
        return {
            'CAM_A2': cls.__constants['CAM_A2'],
            'CAM_R1M_1': cls.__constants['CAM_R1M_1'],
            'CAM_R1M_2': cls.__constants['CAM_R1M_2'],
            'CAM_R1M_3': cls.__constants['CAM_R1M_3'],
        }

    @property
    def CAM_A2(self):
        """Message constant 'CAM_A2'."""
        return Metaclass_CameraControl.__constants['CAM_A2']

    @property
    def CAM_R1M_1(self):
        """Message constant 'CAM_R1M_1'."""
        return Metaclass_CameraControl.__constants['CAM_R1M_1']

    @property
    def CAM_R1M_2(self):
        """Message constant 'CAM_R1M_2'."""
        return Metaclass_CameraControl.__constants['CAM_R1M_2']

    @property
    def CAM_R1M_3(self):
        """Message constant 'CAM_R1M_3'."""
        return Metaclass_CameraControl.__constants['CAM_R1M_3']
