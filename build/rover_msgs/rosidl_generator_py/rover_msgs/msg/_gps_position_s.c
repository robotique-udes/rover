...
bool rover_msgs__msg__gps_position__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rover_msgs.msg._gps_position.GpsPosition", full_classname_dest, 40) == 0);
  }
  rover_msgs__msg__GpsPosition * ros_message = _ros_message;
  {  // latitude
...
{
  /* NOTE(esteve): Call constructor of GpsPosition */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("rover_msgs.msg._gps_position");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "GpsPosition");
