...
class QUtilityBarTop : public QWidget
{
    ...
    static constexpr const char* TOPIC_WIFI_CONNECTION = "/rover/antenna/status";
  ...
  signals:
    ...
    void updateWifiUI(bool connected_, float rssi_, float speed_);
  ...
  private slots:
    ...
    void onUpdateWifiUI(bool connected_, float rssi_, float speed_);
  ...
  private:
    ...
    void CB_wifiConnection(rover_msgs::msg::AntennaStatus& msg_);
    ...
    std::shared_ptr<rclcpp::Subscription<rover_msgs::msg::AntennaStatus>> _sub_wifiConnection;
