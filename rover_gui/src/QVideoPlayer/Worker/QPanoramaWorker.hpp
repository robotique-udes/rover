...
class QPanoramaWorker : public QWorker
{
  ...
  private:
    ...
    static constexpr uint16_t SERVICE_TIMEOUT_MS = 4'000U; // Additional time to account for initializing camera position, stitching the frames and correction warp
