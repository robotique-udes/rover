#ifndef __CAM_CONTROL_HPP__
#define __CAM_CONTROL_HPP__
...
namespace RoverCanLib::Msgs
{
    ...
    public:
        ...
        {
            if (msg_->data[(uint8_t)Constant::eDataIndex::MSG_ID] != (uint8_t)Constant::eMsgId::CAM_CONTROL)
            {
            ...
            switch ((Msgs::camControl::eMsgID)(msg_->data[(uint8_t)Constant::eDataIndex::MSG_CONTENT_ID]))
            {
            case eMsgID::ENABLE:
        ...
        {
            msg_->data[(uint8_t)Constant::eDataIndex::MSG_ID] = (uint8_t)Constant::eMsgId::CAM_CONTROL;
            msg_->data[(uint8_t)Constant::eDataIndex::MSG_CONTENT_ID] = msgId_;

            switch ((RoverCanLib::Msgs::camControl::eMsgID)msgId_)
            {
            case eMsgID::ENABLE:
