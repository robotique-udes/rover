...
JoyFormator::JoyFormator() : Node("joy_formator")
{
    ...
    _sub_log = this->create_subscription<rcl_interfaces::msg::Log>(this->get_parameter("debug_topic").as_string(), 1, std::bind(&JoyFormator::callbackJoy, this, std::placeholders::_1));
}
