...
To setup your computer for development, [read this page](https://github.com/robotique-udes/rover_documentation/blob/main/doc/prog/how_to/Setup/1_read_first.md). The rest of the documentation takes for granted that you are all set up.

### Useful links

- [Rovus Github Project](https://github.com/orgs/robotique-udes/projects/1/views/1): Task management, backlog and test planning
- [Coding Guidelines](https://github.com/robotique-udes/rover_documentation/blob/main/doc/prog/Coding%20Guidelines.md): Good practices and styling guide
- [Electrical Standard](https://github.com/robotique-udes/rover_documentation/blob/main/doc/electrical/electric_standard.md): Like coding guidelines but for electrical elements
- [Testing for the first time guide TODO](TODO): Guide to start, test and stop the rover safely
- [Documentation](https://github.com/robotique-udes/rover_documentation/tree/main/doc): Folder with all the documentation
...
- [How to request new feature on the GUI](https://github.com/robotique-udes/rover_documentation/blob/main/doc/prog/projects/gui/feature_request.md): Procedure to make request for GUI element necessary for your tasks
- [How to use the GUI](https://github.com/robotique-udes/rover_documentation/blob/main/doc/prog/projects/gui/how_to_use_GUI.md): Procedure to launch and develop the rover GUI
- [ADD MORE!]()
