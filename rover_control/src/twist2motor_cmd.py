...
class LowLevelControlNode(object):
    ...
    def send_cmd(self):
        ...
        """
        # Left wheels
        self.m1_pub.publish(cmd(cmd_mode=0, cmd=self.l_cmd))
        self.m3_pub.publish(cmd(cmd_mode=0, cmd=self.l_cmd))

        # Right wheels
        self.m2_pub.publish(cmd(cmd_mode=0, cmd=self.r_cmd))
        self.m4_pub.publish(cmd(cmd_mode=0, cmd=self.r_cmd))
