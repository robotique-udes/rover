...
namespace Command::Base
{
    ...
    class GetInterfaceStats : public AntennaCommand
    {
      private:
        ...
        static constexpr uint8_t INTERFACE_WLAN_INDEX = 0U;
        static constexpr uint8_t INTERFACE_LAN_INDEX = 1U;
      ...
      private:
        ...
        const uint64_t _publisherPeriodMs;
