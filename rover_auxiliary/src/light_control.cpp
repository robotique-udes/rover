...
LightControl::LightControl(): Node("light_controller")
{
    ...
    _srvLightControl = this->create_service<rover_msgs::srv::LightControl>(
        "/rover/auxiliary/set/lights",
        std::bind(&LightControl::CB_srv, this, std::placeholders::_1, std::placeholders::_2));
}
