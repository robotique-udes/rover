...
namespace CameraManager
{
    class ManagerNode : public rclcpp::Node
    {
      ...
      private:
        ...
        std::array<rclcpp::Subscription<rover_msgs::msg::CameraControl>::SharedPtr, Arbitration::NUMBER_TOPIC_CAMERA_ARBITRATION> _sub_PTZCmd;
        std::array<rclcpp::Subscription<rover_msgs::msg::CameraControl>::SharedPtr, Arbitration::NUMBER_TOPIC_CAMERA_ARBITRATION> _sub_PTZConfig;
        std::array<rclcpp::Subscription<rover_msgs::msg::CameraControl>::SharedPtr, Arbitration::NUMBER_TOPIC_CAMERA_ARBITRATION> _sub_powerCmd;
