...
bool rover_msgs__msg__aruco__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rover_msgs.msg._aruco.Aruco", full_classname_dest, 27) == 0);
  }
  rover_msgs__msg__Aruco * ros_message = _ros_message;
  {  // valid
...
PyObject * rover_msgs__msg__aruco__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("rover_msgs.msg._aruco");
