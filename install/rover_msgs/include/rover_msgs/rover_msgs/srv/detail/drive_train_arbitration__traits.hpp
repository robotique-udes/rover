...
#include "rover_msgs/msg/detail/drivetrain_arbitration__traits.hpp"
  ...
  std::ostream & out)
{
  ...
  // member: target_arbitration
  {
    ...
    to_flow_style_yaml(msg.target_arbitration, out);
  }
  out << "}";
  ...
  std::ostream & out, size_t indentation = 0)
{
  // member: target_arbitration
  {
    ...
    out << "target_arbitration:\n";
    to_block_style_yaml(msg.target_arbitration, out, indentation + 2);
  }
}  // NOLINT(readability/fn_size)
...
struct has_fixed_size<rover_msgs::srv::DriveTrainArbitration_Request>
  : std::integral_constant<bool, has_fixed_size<rover_msgs::msg::DrivetrainArbitration>::value> {};

template<>
struct has_bounded_size<rover_msgs::srv::DriveTrainArbitration_Request>
  : std::integral_constant<bool, has_bounded_size<rover_msgs::msg::DrivetrainArbitration>::value> {};
  ...
  std::ostream & out)
{
  ...
  // member: current_arbitration
  {
    ...
    to_flow_style_yaml(msg.current_arbitration, out);
  }
  out << "}";
}  // NOLINT(readability/fn_size)
  ...
  std::ostream & out, size_t indentation = 0)
{
  // member: current_arbitration
  {
    ...
    out << "current_arbitration:\n";
    to_block_style_yaml(msg.current_arbitration, out, indentation + 2);
  }
}  // NOLINT(readability/fn_size)
