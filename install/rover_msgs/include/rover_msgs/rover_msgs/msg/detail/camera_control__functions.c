...
rover_msgs__msg__CameraControl__create()
{
  ...
  rover_msgs__msg__CameraControl * msg = (rover_msgs__msg__CameraControl *)allocator.allocate(sizeof(rover_msgs__msg__CameraControl), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(rover_msgs__msg__CameraControl));
  bool success = rover_msgs__msg__CameraControl__init(msg);
  if (!success) {
...
rover_msgs__msg__CameraControl__destroy(rover_msgs__msg__CameraControl * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    rover_msgs__msg__CameraControl__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
rover_msgs__msg__CameraControl__Sequence__init(rover_msgs__msg__CameraControl__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rover_msgs__msg__CameraControl * data = NULL;

  if (size) {
    data = (rover_msgs__msg__CameraControl *)allocator.zero_allocate(size, sizeof(rover_msgs__msg__CameraControl), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = rover_msgs__msg__CameraControl__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        rover_msgs__msg__CameraControl__fini(&data[i - 1]);
      }
...
rover_msgs__msg__CameraControl__Sequence__fini(rover_msgs__msg__CameraControl__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      rover_msgs__msg__CameraControl__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rover_msgs__msg__CameraControl__Sequence * array = (rover_msgs__msg__CameraControl__Sequence *)allocator.allocate(sizeof(rover_msgs__msg__CameraControl__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = rover_msgs__msg__CameraControl__Sequence__init(array, size);
  if (!success) {
...
rover_msgs__msg__CameraControl__Sequence__destroy(rover_msgs__msg__CameraControl__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    rover_msgs__msg__CameraControl__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
rover_msgs__msg__CameraControl__Sequence__are_equal(const rover_msgs__msg__CameraControl__Sequence * lhs, const rover_msgs__msg__CameraControl__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!rover_msgs__msg__CameraControl__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  rover_msgs__msg__CameraControl__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(rover_msgs__msg__CameraControl);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    rover_msgs__msg__CameraControl * data =
      (rover_msgs__msg__CameraControl *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!rover_msgs__msg__CameraControl__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          rover_msgs__msg__CameraControl__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!rover_msgs__msg__CameraControl__copy(
