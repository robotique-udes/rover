...
Recording::Recording(Recording&& other) noexcept:
    ...
    _cap(std::move(other._cap)), // NOLINT(performance-move-constructor-init)
    _video_writer_short(std::move(other._video_writer_short)), // NOLINT(performance-move-constructor-init)
    _video_writer_long(std::move(other._video_writer_long)), // NOLINT(performance-move-constructor-init)
