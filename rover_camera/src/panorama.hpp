...
{
  private:
    static constexpr float MAX_TILT_SPEED_PANORAMA = 15.0F;  // deg/s
    static constexpr float MAX_TILT_SPEED_GUI = 10.0F;       // rad/s
  ...
  private:
    ...
    void configPtz(uint8_t idCam_, float tiltSpeed_);
